                ...
                <div class="panel-body" >
                    ...
                    <div id="bdd_fields">
                        ...
                        <div id="div_id_driver" class="form-group required">
                            ...
                            <select id="driver_bdd"  class="custom-select form-control controls <?php if (isset($_SESSION[$form_id]['message_error_bdd']['driver'])){echo "alert-danger";} ?>" name="driver_bdd" title="<?=$_SESSION[$form_id]['message_error_bdd']['driver']?>">
                        ...
                        <div id="div_id_charset" class="form-group required">
                            ...
                            <select id="charset_bdd" class="custom-select form-control controls <?php if (isset($_SESSION[$form_id]['message_error_bdd']['charset'])){echo "alert-danger";} ?>" name="charset_bdd" title="<?=$_SESSION[$form_id]['message_error_bdd']['charset']?>">
                        ...
                        <div class="form-group">
                            ...
                            <div id="mail_fields">
                                ...
                                <div id="div_id_to_mail" class="form-group required">
                                    ...
                                    <div class="controls col-md-8 ">
                                        <input title="<?=$_SESSION[$form_id]['message_error_mail']['to_mail']?>" <?php if (isset($_SESSION[$form_id]['field_mail']['mail_provided'])){echo 'value="'.$_SESSION[$form_id]['field_mail']['mail_provided'].'"';}?> class="input-md textinput textInput form-control <?php if (isset($_SESSION[$form_id]['message_error_mail']['to_mail'])){echo "alert-danger";} ?>" id="id_to_mail" name="to_mail" placeholder="destinataire" style="margin-bottom: 10px"  />
                                    </div>
                                </div>
                                <input type="button" id="testMail" class="btn btn-lg btn-success pull-right" value="tester le mail">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body" >
                        ...
                        <div class="form-group">
                            ...
                            <div class="controls col-md-8 ">
                                <input autocomplete="off" type="submit" name="Signup" value="Généré" class="btn btn-primary btn btn-danger" id="submit-id-signup" onclick="return validate()" />
                            </div>
                        </div>
                    </div>
                </div>
