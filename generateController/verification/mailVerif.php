...
function is_Mail(array $posts){
  ...
  if(isset($posts['mail_provided']) && !filter_var($posts['mail_provided'],FILTER_VALIDATE_EMAIL))$msg['to_mail']='Le champs destinataire n\'est pas une adresse mail valide';
